...
begin
  randomize; //Randomize in RandomCord funktioniert nicht, da mehrmals nahezu gleiche Zufallszahlen berechnet werden
...
begin
    ...
    //Schlangenmindestlänge festlegen
    if Schwanzanzahl < Mindestlaenge-1 then
      Schwanzerstellen;
